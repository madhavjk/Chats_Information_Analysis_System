...
if uploaded_file is not None:
    ...
    st.subheader("Textual Chat Analysis for : " + selected_user)
    if st.sidebar.button("Show Analysis"):
        ...
        # number of messages,number of media shared and all,so for that 
        # I requrire the 4 columns
    ...
    st.sidebar.write('Made by Madhav Sharma')
